==============================================================================
Lean 4 Replication Guide for DGAA Supplement (Appendix B)
==============================================================================

This directory contains the replication package for the formal proofs and Lean
verification of the paper:
"Identifying Rational Types in Unknown Environments under an Indirect Dynamic Mechanism" (Dynamic Games and Applications - DGAA).

GitHub Repository: https://github.com/Donzhumber/DGAA.git
